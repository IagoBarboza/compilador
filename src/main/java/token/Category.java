...
public enum Category {
    ...
    FUN(43), CONTINUE(44), BREAK(45), CON_INT(46), CON_FLO(47), CON_BOO(48), CON_CHA(49), CON_STR(50),
    CON_INT_CAD(51), CON_FLO_CAD(52), CON_BOO_CAD(53), CON_CHA_CAD(54), CON_STR_CAD(55), EOF(56), OPE_FOR_CAM(57), OPE_FOR_DEC(58);
